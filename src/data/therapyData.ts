            ...
            details: [
              {
                label: 'Task',
                type: 'select',
                options: ['Rolling', 'Supine to Sit', 'Scooting', 'Bridging'],
              },
              {
                label: 'Assistance',
                type: 'select',
                options: ['Min A', 'Mod A', 'Max A', 'Total A', 'SBA', 'Independent'],
              },
          ...
          },
          {
            ...
            details: [
              ...
              },
              {
                label: 'Equipment',
                type: 'select',
                options: ['Raised Toilet Seat', 'Grab Bars', 'Commode', 'None'],
              },
            ],
          },
          {
            ...
            details: [
              ...
              },
              {
                label: 'Equipment',
                type: 'select',
                options: ['Shower Chair', 'Transfer Bench', 'Grab Bars', 'None'],
              },
            ],
          },
          {
            ...
            details: [
              ...
              },
              {
                label: 'Technique',
                type: 'select',
                options: ['Stand Pivot', 'Squat Pivot', 'Slide Board'],
              },
            ],
          },
        ],
            ...
            details: [
              {
                label: 'Task',
                type: 'select',
                options: ['Pegboard', 'Stacking', 'Sorting', 'In-hand manipulation', 'Lacing'],
              },
              {
                label: 'Accuracy (%)',
                type: 'select',
            ...
            details: [
              {
                label: 'Task',
                type: 'select',
                options: ['Copying', 'Writing Name', 'Writing Sentences', 'Dictation'],
              },
              { label: 'Legibility', type: 'select', options: ['Good', 'Fair', 'Poor'] },
              {
                label: 'Grip',
                type: 'select',
                options: ['Dynamic Tripod', 'Lateral Tripod', 'Cross Thumb', 'Palmar'],
              },
            ],
          },
        ],
            ...
            details: [
              {
                label: 'Task',
                type: 'select',
                options: ['Cleaning', 'Laundry', 'Organization', 'Sweeping/Vacuuming'],
              },
              { label: 'Endurance (min)', type: 'number' },
              {
                label: 'Assistance',
                type: 'select',
                options: ['Min A', 'Mod A', 'Max A', 'SBA', 'Independent'],
              },
            ],
          },
          {
            ...
            details: [
              {
                label: 'Task',
                type: 'select',
                options: ['Pill Organizer', 'Reading Labels', 'Timing/Scheduling'],
              },
              {
                label: 'Accuracy (%)',
                type: 'select',
            ...
            details: [
              {
                label: 'Task',
                type: 'select',
                options: ['Budgeting', 'Paying Bills', 'Writing Checks', 'Counting Change'],
              },
              {
                label: 'Accuracy (%)',
                type: 'select',
            ...
            details: [
              {
                label: 'Task',
                type: 'multi-select',
                options: ['Don/Doff shirt', 'Fasteners', 'Bra', 'Jacket'],
              },
              {
                label: 'Assistance',
                type: 'select',
            ...
            details: [
              {
                label: 'Task',
                type: 'multi-select',
                options: ['Don/Doff pants', 'Socks', 'Shoes', 'AFO/Brace'],
              },
              {
                label: 'Assistance',
                type: 'select',
            ...
            details: [
              {
                label: 'Task',
                type: 'multi-select',
                options: ['Oral Care', 'Hair Care', 'Shaving', 'Face Washing', 'Deodorant'],
              },
              {
                label: 'Assistance',
                type: 'select',
            ...
            details: [
              {
                label: 'Task',
                type: 'multi-select',
                options: ['Clothing management', 'Hygiene/Wiping', 'Transfers'],
              },
              {
                label: 'Assistance',
                type: 'select',
            ...
            details: [
              {
                label: 'Task',
                type: 'multi-select',
                options: ['Washing upper body', 'Washing lower body', 'Washing back', 'Drying'],
              },
              {
                label: 'Assistance',
                type: 'select',
            ...
            details: [
              {
                label: 'Task',
                type: 'multi-select',
                options: ['Utensil use', 'Cup drinking', 'Cutting food', 'Opening packages'],
              },
              {
                label: 'Assistance',
                type: 'select',
            ...
            details: [
              {
                label: 'Equipment',
                type: 'multi-select',
                options: ['Reacher', 'Sock Aid', 'Shoe Horn', 'Button Hook', 'Dressing Stick'],
              },
            ...
            details: [
              {
                label: 'Joint',
                type: 'multi-select',
                options: ['Shoulder', 'Elbow', 'Wrist', 'Digits'],
              },
              { label: 'Reps', type: 'number' },
              { label: 'Sets', type: 'number' },
            ],
            ...
            details: [
              {
                label: 'Resistance',
                type: 'select',
                options: ['Yellow', 'Red', 'Green', 'Blue', 'Black', 'Dumbbells (1-5lbs)'],
              },
              { label: 'Reps', type: 'number' },
              { label: 'Sets', type: 'number' },
            ],
            ...
            details: [
              {
                label: 'Task',
                type: 'select',
                options: ['Seated balance', 'Reaching out of base of support', 'Trunk rotation'],
              },
              { label: 'Duration (min)', type: 'number' },
              {
                label: 'Assistance',
            ...
            details: [
              {
                label: 'Activity',
                type: 'select',
                options: ['Standing task', 'Seated task', 'Dynamic task'],
              },
              { label: 'Duration (min)', type: 'number' },
            ...
            details: [
              {
                label: 'Task',
                type: 'select',
                options: ['Weight distribution', 'Symmetry', 'Midline Orientation'],
              },
              { label: 'Cueing', type: 'select', options: ['Verbal', 'Visual', 'Tactile'] },
              { label: 'Duration (min)', type: 'number' },
            ],
            ...
            details: [
              {
                label: 'Technique',
                type: 'select',
                options: ['Texture', 'Pressure', 'Temperature', 'Vibration'],
              },
            ...
            details: [
              {
                label: 'Task',
                type: 'select',
                options: ['Weight Bearing', 'Joint Compression', 'Heavy Work'],
              },
              { label: 'Duration (min)', type: 'number' },
            ],
          },
            ...
            details: [
              {
                label: 'Task',
                type: 'select',
                options: ['Scanning', 'Figure-ground', 'Spatial relations', 'Visual closure'],
              },
              {
                label: 'Accuracy (%)',
                type: 'select',
            ...
            details: [
              {
                label: 'Exercise',
                type: 'multi-select',
                options: ['Squats', 'Leg Press', 'Step-ups', 'Wall Slides', 'Heel Raises'],
              },
              { label: 'Reps', type: 'number' },
              { label: 'Sets', type: 'number' },
              {
                label: 'Resistance',
                type: 'select',
                options: ['Bodyweight', 'Light', 'Moderate', 'Heavy'],
              },
            ],
          },
          {
            ...
            details: [
              ...
              { label: 'Sets', type: 'number' },
              {
                label: 'Resistance',
                type: 'select',
                options: ['None', 'Yellow', 'Red', 'Green', 'Blue', 'Ankle Weights'],
              },
            ],
          },
        ],
            ...
            details: [
              {
                label: 'Muscle Group',
                type: 'multi-select',
                options: ['Hamstrings', 'Calf/Gastroc', 'Hip Flexors', 'Quads'],
              },
            ...
            details: [
              {
                label: 'Stance',
                type: 'select',
                options: ['Romberg', 'Tandem', 'Semi-Tandem', 'Single Leg Stance'],
              },
              ...
              { label: 'Eyes', type: 'select', options: ['Open', 'Closed'] },
              {
                label: 'Assistance',
                type: 'select',
                options: ['Min A', 'Mod A', 'Max A', 'SBA', 'CGA', 'Independent'],
              },
            ],
          },
          {
            ...
            details: [
              ...
              },
              {
                label: 'Assistance',
                type: 'select',
                options: ['Min A', 'Mod A', 'Max A', 'SBA', 'CGA'],
              },
            ...
            details: [
              {
                label: 'Surface',
                type: 'select',
                options: ['Firm', 'Foam Pad', 'Uneven Terrain', 'Wobble Board', 'Dynadisc'],
              },
              { label: 'Duration (min)', type: 'number' },
              {
                label: 'Assistance',
            ...
            details: [
              {
                label: 'Feedback',
                type: 'select',
                options: ['Visual (Mirror)', 'Tactile', 'Verbal'],
              },
              { label: 'Duration (min)', type: 'number' },
            ],
          },
            ...
            details: [
              {
                label: 'Distance (ft)',
                type: 'select',
                options: ['10-25', '25-50', '50-100', '100-150', '150-200', '200+'],
              },
              {
                label: 'Device',
                type: 'select',
                options: ['None', 'RW', 'PUW', 'SPC', 'Quad Cane', 'Hemi Walker'],
              },
              {
                label: 'Assistance',
                type: 'select',
            ...
            details: [
              {
                label: 'Surface',
                type: 'select',
                options: ['Grass', 'Gravel', 'Ramps', 'Carpet to Tile'],
              },
              {
                label: 'Distance (ft)',
                type: 'select',
            ...
            details: [
              {
                ...
                type: 'select',
                options: ['RW', 'PUW', 'SPC', 'Quad Cane', 'Hemi Walker'],
              },
              {
                label: 'New Device',
                type: 'select',
          ...
          },
          {
            ...
            details: [
              ...
              { label: 'Education Provided', type: 'select', options: ['Yes', 'No'] },
              {
                ...
                type: 'select',
                options: ['Accurate', 'Required cues', 'Unable'],
              },
            ],
          },
        ],
        ...
        activities: [
          {
            ...
            details: [
              { label: 'Number of Steps', type: 'number' },
              {
                label: 'Handrail Use',
                type: 'select',
                options: ['Bilateral', 'Unilateral', 'None'],
              },
              {
                label: 'Assistance',
                type: 'select',
          ...
          },
          {
            ...
            details: [
              { label: 'Height (inches)', type: 'select', options: ['2', '4', '6', '8'] },
              {
                label: 'Device',
                type: 'select',
                options: ['None', 'RW', 'PUW', 'SPC', 'Quad Cane'],
              },
              {
                label: 'Assistance',
                type: 'select',
            ...
            details: [
              {
                label: 'Surface',
                type: 'select',
                options: ['Standard Chair', 'Low Bed', 'Toilet', 'Wheelchair'],
              },
              { label: 'Reps', type: 'number' },
              {
                label: 'Assistance',
                type: 'select',
                options: ['Min A', 'Mod A', 'Max A', 'Total A', 'SBA', 'CGA', 'Independent'],
              },
              { label: 'Cueing', type: 'select', options: ['Verbal', 'Visual', 'Tactile'] },
            ],
          },
            ...
            details: [
              {
                label: 'Technique',
                type: 'select',
                options: ['Half-kneel', 'Quadruped to chair', 'Side-sit to chair'],
              },
              {
                label: 'Assistance',
                type: 'select',
            ...
            details: [
              {
                label: 'Task',
                type: 'select',
                options: ['Floor to waist', 'Waist to crown', 'Carrying 10ft'],
              },
