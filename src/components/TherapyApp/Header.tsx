      ...
      <div className="max-w-[100rem] mx-auto px-8 h-full flex items-center justify-between">
        <div className="flex items-center gap-4">
          ...
          <div>
            <h1 className="font-black text-xl tracking-tighter uppercase">
              TheraDoc <span className="text-emerald-500">AI</span>
            </h1>
        ...
        <div className="flex items-center gap-3">
          ...
          >
            ...
            <span className="absolute -bottom-8 right-0 bg-zinc-900 text-white text-[8px] font-black px-2 py-1 rounded opacity-0 group-hover:opacity-100 transition-opacity whitespace-nowrap">
              HIPAA CLEAN
            </span>
          </button>
          <button
          ...
          >
            <Settings
              className={`w-5 h-5 transition-transform group-hover:rotate-90 ${showStyleSettings ? 'text-zinc-950' : 'text-zinc-600'}`}
            />
          </button>
        </div>
      </div>
