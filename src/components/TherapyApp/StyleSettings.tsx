        ...
        >
          <div className="space-y-8">
            <div className="flex items-center justify-between">
              <h3 className="font-black text-xs uppercase tracking-[0.2em] text-zinc-900">AI Configuration</h3>
            ...
            <div className="space-y-4">
              <label className="text-[10px] font-black uppercase tracking-widest text-zinc-400">Writing Style Description</label>
              <textarea
            ...
            <div className="space-y-4">
              <div className="flex items-center justify-between">
                <label className="text-[10px] font-black uppercase tracking-widest text-zinc-400">Style Transfer Samples</label>
                <div className="flex items-center gap-3">
                  <span className="text-[9px] font-bold text-emerald-500 uppercase tracking-widest">{userStyleSamples.length}/5 Samples</span>
              ...
              <div className="space-y-2">
                {userStyleSamples.map((sample, i) => (
                  <div key={i} className="flex items-center justify-between bg-zinc-50 p-3 rounded-xl border border-zinc-100">
                    <span className="text-[10px] font-bold text-zinc-600 truncate max-w-[200px]">{sample}</span>
                    <button 
                      onClick={() => {
                ...
                {userStyleSamples.length < 5 && (
                  <div className="space-y-2">
                    ...
                    <button 
                      onClick={() => {
                        const el = document.getElementById('new-sample-input') as HTMLTextAreaElement;
                        if (el && el.value.trim()) {
            ...
            <div className="pt-6 border-t border-zinc-100">
              <div className="flex items-center justify-between">
                <div>
                  <p className="text-[11px] font-black uppercase tracking-widest text-zinc-950">Local Processing Mode</p>
                  <p className="text-[9px] font-bold text-zinc-400 uppercase tracking-widest mt-1">Reduce API dependency</p>
                </div>
                <button 
