...
export const DetailsStep: React.FC = () => {
  ...
  const matchingTemplates = customTemplates.filter(
    (t) =>
  ...
  return (
    <div className="space-y-12">
      <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-4">
        <div className="space-y-4">
          <h2 className="text-4xl font-black tracking-tight text-zinc-950 uppercase italic">
            Clinical <span className="text-zinc-300 not-italic">Details</span>
          </h2>
          <p className="text-sm font-bold text-zinc-400 uppercase tracking-widest">
            Intervention parameters & observations
          </p>
        </div>
      ...
      {matchingTemplates.length > 0 && (
        <div className="space-y-4" data-tour="gap-analysis">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-10" data-tour="details">
                  ...
                  <VoiceInput
                    onTranscript={(t) =>
                      setState({
                        ...
                        details: {
                          ...state.details,
                          [d.label]: (state.details[d.label] || '') + ' ' + t,
                        },
                      })
                    }
                  />
