  ...
  return (
    <div className="space-y-12">
      <div className="space-y-4">
        <h2 className="text-4xl font-black tracking-tight text-zinc-950 uppercase italic">Treatment <span className="text-zinc-300 not-italic">Mode</span></h2>
        <p className="text-sm font-bold text-zinc-400 uppercase tracking-widest">Clinical delivery context</p>
      </div>
          ...
          >
            <div className="flex items-center justify-between mb-6">
              <div className={cn(
                ...
                state.mode === m.name ? "bg-white/10 text-white" : "bg-zinc-50 text-zinc-950 group-hover:bg-zinc-950 group-hover:text-white"
              )}>
                {m.name[0]}
              </div>
            ...
            <p className="text-[10px] font-bold text-zinc-400 uppercase tracking-widest leading-relaxed">
              {m.name === 'Individual' ? 'One-on-one skilled intervention' : 
               m.name === 'Group' ? 'Concurrent or group therapy session' :
