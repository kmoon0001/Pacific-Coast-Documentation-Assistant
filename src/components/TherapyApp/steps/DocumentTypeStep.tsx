    ...
    <div className="space-y-12">
      <div className="space-y-4">
        <h2 className="text-4xl font-black tracking-tight text-zinc-950 uppercase italic">
          Document <span className="text-zinc-300 not-italic">Type</span>
        </h2>
      ...
      {/* Brain Dump Section */}
      <div
        className="p-10 rounded-[2.5rem] bg-zinc-950 text-white shadow-2xl shadow-zinc-950/20 relative overflow-hidden group"
        ...
        <div className="relative z-10 space-y-8">
          ...
          <div className="flex items-center gap-6 text-[9px] font-bold text-zinc-500 uppercase tracking-widest">
            <span className="flex items-center gap-2">
              <div className="w-1 h-1 bg-emerald-500 rounded-full" /> Auto-Discipline
            </span>
            <span className="flex items-center gap-2">
              <div className="w-1 h-1 bg-emerald-500 rounded-full" /> Auto-CPT
            </span>
            <span className="flex items-center gap-2">
              <div className="w-1 h-1 bg-emerald-500 rounded-full" /> Clinical Extraction
            </span>
          </div>
        </div>
      </div>
      ...
      <div className="space-y-8">
        ...
        <div
          ...
          data-testid="doc-type-grid"
          data-tour="document-type"
        >
          {docTypes.map((t) => (
            <button
              key={t.id}
