  ...
  getTemplates: (_discipline: string, _documentType: string): Template[] => {
    const defaultTemplates: Template[] = [
      ...
      },
      {
        ...
        state: {
          customNote:
            'Pt demonstrated improved safety awareness. Pt required verbal cues for safety.',
        },
      },
      {
        ...
        state: {
          customNote:
            'Pt participated in cognitive-communication tasks to maintain functional status and safety.',
        },
      },
      {
        ...
        state: {
          customNote:
            'Pt required skilled intervention for safe transfers and functional mobility.',
        },
      },
    ];
