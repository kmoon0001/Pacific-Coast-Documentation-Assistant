...
describe('SHAP Fact-Check Service', () => {
  describe('factCheckNote', () => {
    ...
    it('should identify discipline-specific terminology', () => {
      ...
      const noteWithPTTerms = 'Patient worked on gait training and therapeutic exercise to improve mobility.';
      const result = factCheckNote(ptState, noteWithPTTerms);
      
      const disciplineCheck = result.consistencyChecks.find(c => c.id === 'discipline_consistency');
