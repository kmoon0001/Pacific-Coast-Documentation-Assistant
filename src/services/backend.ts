...
export function createBackendServer(): Express {
  ...
  app.post(
    ...
    async (req: Request, res: Response) => {
      try {
        ...
        const document = await knowledgeBaseService.uploadDocument(fileObj, metadata, userId);
  ...
  app.get(
    '/api/knowledge-base/documents/search',
    authenticateMiddleware,
    async (req: Request, res: Response) => {
      try {
        const userId = (req as any).userId;
        ...
        const result = await knowledgeBaseService.searchDocuments(userId, q as string, filters);
  ...
  app.patch(
    ...
    async (req: Request, res: Response) => {
      try {
        ...
        const document = await knowledgeBaseService.updateDocumentMetadata(req.params.id, userId, {
          title,
          description,
          category,
          effectiveDate,
  ...
  app.get(
    '/api/knowledge-base/documents/:id/usage',
    authenticateMiddleware,
    async (req: Request, res: Response) => {
      try {
  ...
  app.get(
    '/api/knowledge-base/documents/:id/audit',
    authenticateMiddleware,
    async (req: Request, res: Response) => {
      try {
  ...
  app.get(
    '/api/knowledge-base/documents/:id/versions',
    authenticateMiddleware,
    async (req: Request, res: Response) => {
      try {
  ...
  app.get(
    '/api/knowledge-base/documents/:id/versions/stats',
    authenticateMiddleware,
    async (req: Request, res: Response) => {
      try {
        const { versioningService } = await import('./versioningService');
  ...
  app.get(
    '/api/knowledge-base/documents/:id/versions/:versionNumber',
    authenticateMiddleware,
    async (req: Request, res: Response) => {
      try {
        const { versioningService } = await import('./versioningService');
  ...
  app.post(
    '/api/knowledge-base/documents/:id/versions/compare',
    authenticateMiddleware,
    async (req: Request, res: Response) => {
      try {
        ...
        const diff = await versioningService.compareVersions(req.params.id, fromVersion, toVersion);
  ...
  app.post(
    '/api/knowledge-base/documents/:id/versions/:versionNumber/restore',
    authenticateMiddleware,
    async (req: Request, res: Response) => {
      try {
        const userId = (req as any).userId;
  ...
  app.post(
    '/api/knowledge-base/relationships',
    authenticateMiddleware,
    async (req: Request, res: Response) => {
      try {
        const userId = (req as any).userId;
  ...
  app.get(
    '/api/knowledge-base/documents/:id/relationships',
    authenticateMiddleware,
    async (req: Request, res: Response) => {
      try {
  ...
  app.post(
    '/api/knowledge-base/relationships/detect-conflicts',
    authenticateMiddleware,
    async (req: Request, res: Response) => {
      try {
  ...
  app.delete(
    '/api/knowledge-base/relationships/:id',
    authenticateMiddleware,
    async (req: Request, res: Response) => {
      try {
        const userId = (req as any).userId;
  ...
  app.get(
    '/api/knowledge-base/documents/:id/relationships/graph',
    authenticateMiddleware,
    async (req: Request, res: Response) => {
      try {
        const { relationshipService } = await import('./relationshipService');
  ...
  app.get(
    '/api/knowledge-base/documents/:id/relationships/stats',
    authenticateMiddleware,
    async (req: Request, res: Response) => {
      try {
        const { relationshipService } = await import('./relationshipService');
    ...
    async (req: Request, res: Response) => {
      try {
        ...
        const fileObjects = files.map(
          (f: any) => new File([Buffer.from(f.data, 'base64')], f.name, { type: f.type })
        );
  ...
  app.post(
    '/api/knowledge-base/bulk/delete',
    authenticateMiddleware,
    async (req: Request, res: Response) => {
      try {
        const userId = (req as any).userId;
  ...
  app.post(
    '/api/knowledge-base/bulk/update-tags',
    authenticateMiddleware,
    async (req: Request, res: Response) => {
      try {
        const userId = (req as any).userId;
  ...
  app.post(
    '/api/knowledge-base/bulk/update-category',
    authenticateMiddleware,
    async (req: Request, res: Response) => {
      try {
        const userId = (req as any).userId;
